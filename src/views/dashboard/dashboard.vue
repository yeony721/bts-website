    ...
    <div class="content-header">
      <div class="d-sm-flex align-items-center justify-content-between">
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">대시보드</h4>
        </div>
      </div>
    </div>
      ...
      <div class="container pd-x-0">
        <div class="row row-xs">
              ...
              <div class="d-flex d-lg-block d-xl-flex align-items-end">
                ...
                <p class="tx-11 tx-color-03 mg-b-0">
                  <span class="tx-medium tx-success"
                    >1.2% <i class="icon ion-md-arrow-up"></i
                  ></span>
                </p>
              </div>
              ...
              <div class="d-flex d-lg-block d-xl-flex align-items-end">
                ...
                <p class="tx-11 tx-color-03 mg-b-0">
                  <span class="tx-medium tx-danger"
                    >0.7% <i class="icon ion-md-arrow-down"></i
                  ></span>
                </p>
              </div>
              <div class="chart-three">
          ...
          <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
            <div class="card card-body">
              ...
              <div class="d-flex d-lg-block d-xl-flex align-items-end">
                ...
                <p class="tx-11 tx-color-03 mg-b-0">
                  <span class="tx-medium tx-danger"
                    >0.3% <i class="icon ion-md-arrow-down"></i
                  ></span>
                </p>
              </div>
              <div class="chart-three">
          ...
          <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
            <div class="card card-body">
              ...
              <div class="d-flex d-lg-block d-xl-flex align-items-end">
                ...
                <p class="tx-11 tx-color-03 mg-b-0">
                  <span class="tx-medium tx-success"
                    >2.1% <i class="icon ion-md-arrow-up"></i
                  ></span>
                </p>
              </div>
              <div class="chart-three">
          ...
          <div class="col-lg-8 col-xl-7 mg-t-10">
            <div class="card">
              <div
                class="card-header pd-y-20 d-md-flex align-items-center justify-content-between"
              >
                <h6 class="mg-b-0">Recurring Revenue Growth</h6>
                <ul
                  class="list-inline d-flex mg-t-20 mg-sm-t-10 mg-md-t-0 mg-b-0"
                >
                  <li class="list-inline-item d-flex align-items-center">
                    <span
                      class="d-block wd-10 ht-10 bg-df-1 rounded mg-r-5"
                    ></span>
                    <span
                      class="tx-sans tx-uppercase tx-10 tx-medium tx-color-03"
                      >Growth Actual</span
                    >
                  </li>
                  <li class="list-inline-item d-flex align-items-center mg-l-5">
                    <span
                      class="d-block wd-10 ht-10 bg-df-2 rounded mg-r-5"
                    ></span>
                    <span
                      class="tx-sans tx-uppercase tx-10 tx-medium tx-color-03"
                      >Actual</span
                  ...
                  <li class="list-inline-item d-flex align-items-center mg-l-5">
                    <span
                      class="d-block wd-10 ht-10 bg-df-3 rounded mg-r-5"
                    ></span>
                    <span
                      class="tx-sans tx-uppercase tx-10 tx-medium tx-color-03"
                      >Plan</span
                ...
                <div class="pos-absolute t-20 l-20 wd-xl-100p z-index-10">
                  <div class="row">
                    <div class="col-sm-5">
                      ...
                      <h6
                        class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-10"
                      >
                        MRR Growth
                      </h6>
              ...
              <div class="card-body pd-20">
                ...
                <div class="row">
                  <div class="col-sm">
                    ...
                    <p
                      class="tx-11 tx-uppercase tx-spacing-1 tx-semibold mg-b-10 tx-primary"
                    >
                      Expansions
                    </p>
                  ...
                  <div class="col-sm mg-t-20 mg-sm-t-0">
                    ...
                    <p
                      class="tx-11 tx-uppercase tx-spacing-1 tx-semibold mg-b-10 tx-pink"
                    >
                      Cancellations
                    </p>
                    <div class="tx-12 tx-color-03">
                      Customers who have ended their subscription.
                    </div>
                  </div>
                  <!-- col -->
                </div>
            ...
            <div class="card ht-lg-100p">
              ...
              <div class="card-body pd-0">
                ...
                <div class="table-responsive">
                  <table
                    class="table table-borderless table-dashboard table-dashboard-one"
                  >
                    <thead>
                      <tr>
                ...
                <div class="d-sm-flex">
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <h4
                        class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0"
                      >
                        $1,958,104
                      </h4>
                    </div>
                    ...
                    <tr>
                      ...
                      <td class="tx-medium text-right">
                        ...
                        <span class="mg-l-5 tx-10 tx-normal tx-success"
                          ><i class="icon ion-md-arrow-up"></i> 4.5%</span
                        >
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="tx-medium text-right">
                        ...
                        <span class="mg-l-5 tx-10 tx-normal tx-danger"
                          ><i class="icon ion-md-arrow-down"></i> 0.8%</span
                        >
                      </td>
                    </tr>
                    <tr>
            ...
            <div class="card ht-lg-100p">
              ...
              >
                ...
                <ul class="list-inline d-flex mg-b-0">
                  ...
                  <li
                    class="list-inline-item d-flex align-items-center mg-l-10"
                  >
                    <span
                      class="d-block wd-10 ht-10 bg-df-3 rounded mg-r-5"
                    ></span>
                  ...
                  <div class="col">
                    <h5 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">
                      ...
                      <small class="tx-11 tx-success letter-spacing--2"
                        ><i class="icon ion-md-arrow-up"></i> 0.20%</small
                      >
                    </h5>
                    <p
                      class="tx-10 tx-uppercase tx-spacing-1 tx-medium tx-color-03"
                    >
                      Total Sales
                    </p>
                  </div>
                  <div class="col">
                    <h5 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">
                      ...
                      <small class="tx-11 tx-danger letter-spacing--2"
                        ><i class="icon ion-md-arrow-down"></i> 1.04%</small
                      >
                    </h5>
                    <p
                      class="tx-10 tx-uppercase tx-spacing-1 tx-medium tx-color-03"
